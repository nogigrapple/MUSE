...
class Trainer(object):
    def __init__(self, data_config, args):
        ...
        self.model = MUSE(self.n_users, self.n_items, self.feat_embed_dim, self.nonzero_idx, self.nonzero_idx_img, self.nonzero_idx_txt, self.has_norm, self.image_feats, self.text_feats, self.train_items, self.n_layers, self.alpha, self.beta, self.gamma, self.delta)
